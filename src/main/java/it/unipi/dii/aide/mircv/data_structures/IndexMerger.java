...
//                if(term.equals("0000"))
//                    for (Posting p : currentPL) {
//                        term_logger.logInfo(String.valueOf(p.getDocId()));
//                    }
...
//                        assert tempPL != null;
//                        merge_logger.logInfo(tempDE.getTerm());
...
//            delete_tempFiles();                                                                       !!!!!!!!!!!!!!!!
//            merge_logger.logInfo("Terms in dictionary -> " + IndexMerger.termCounter);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

...
public class MaxScore {
     ...
     * @param
     */
    public static void computeMaxScore(ArrayList<PostingList> postingLists, ArrayList<Double> idf, PriorityQueue<ScoreElem> orderByScore) {
        ...
        //orderByScore = new PriorityQueue<>(query.size(), new CompareScoreElem());
